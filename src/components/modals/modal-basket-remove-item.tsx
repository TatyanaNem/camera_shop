...
export function ModalBasketRemoveItem ({modalActive, setModalActive, className}: TModalCatalogAddItemSuccessProps) {
  return (
    <Modal modalActive={modalActive} setModalActive={setModalActive} className={className}>
      ...
      <div className="modal__buttons">
        ...
        <a className="btn btn--transparent modal__btn modal__btn--half-width" href="#">
          Продолжить покупки
        </a>
      </div>
    </Modal>
